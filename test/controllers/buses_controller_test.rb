...
class BusesControllerTest < ActionController::TestCase
  ...
  test "should create bus" do
    assert_difference('Bus.count') do
      post :create, bus: { capacity: @bus.capacity, destiny_city: @bus.destiny_city, name: @bus.name, origin_city: @bus.origin_city }
    end
  ...
  test "should update bus" do
    patch :update, id: @bus, bus: { capacity: @bus.capacity, destiny_city: @bus.destiny_city, name: @bus.name, origin_city: @bus.origin_city }
    assert_redirected_to bus_path(assigns(:bus))
  end
