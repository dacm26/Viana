...
class ItinerariesControllerTest < ActionController::TestCase
  ...
  test "should create itinerary" do
    assert_difference('Itinerary.count') do
      post :create, itinerary: { arrival_time: @itinerary.arrival_time, departure_time: @itinerary.departure_time, id_bus: @itinerary.id_bus }
    end
  ...
  test "should update itinerary" do
    patch :update, id: @itinerary, itinerary: { arrival_time: @itinerary.arrival_time, departure_time: @itinerary.departure_time, id_bus: @itinerary.id_bus }
    assert_redirected_to itinerary_path(assigns(:itinerary))
  end
