...
class VoyagesControllerTest < ActionController::TestCase
  ...
  test "should create voyage" do
    assert_difference('Voyage.count') do
      post :create, voyage: { id_itinerary: @voyage.id_itinerary, seats: @voyage.seats, v_date: @voyage.v_date }
    end
  ...
  test "should update voyage" do
    patch :update, id: @voyage, voyage: { id_itinerary: @voyage.id_itinerary, seats: @voyage.seats, v_date: @voyage.v_date }
    assert_redirected_to voyage_path(assigns(:voyage))
  end
